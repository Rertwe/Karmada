...
export default function SchedulePage() {
  ...
  // Сокращенные названия дней недели (первые 3 буквы)
  const daysOfWeek = [
    { value: "monday", label: t("monday").substring(0, 3) },
    { value: "tuesday", label: t("tuesday").substring(0, 3) },
    { value: "wednesday", label: t("wednesday").substring(0, 3) },
    { value: "thursday", label: t("thursday").substring(0, 3) },
    { value: "friday", label: t("friday").substring(0, 3) },
    { value: "saturday", label: t("saturday").substring(0, 3) },
    { value: "sunday", label: t("sunday").substring(0, 3) },
  ]
          ...
          <Tabs defaultValue="monday" value={activeDay} onValueChange={setActiveDay}>
            ...
            {daysOfWeek.map((day) => (
              <TabsContent key={day.value} value={day.value}>
                <Card>
                  <CardHeader>
                    <CardTitle>{t(day.value)}</CardTitle>
                  </CardHeader>
                  <CardContent>
